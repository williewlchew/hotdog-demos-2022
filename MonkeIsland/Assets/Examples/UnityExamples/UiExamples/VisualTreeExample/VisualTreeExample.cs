...
public class VisualTreeExample : EditorWindow
{

    [MenuItem("Window/UI Toolkit/VisualTreeExample")]
    public static void ShowExample()
    {
        VisualTreeExample wnd = GetWindow<VisualTreeExample>();
        wnd.titleContent = new GUIContent("VisualTreeExample");
    }
